        ...
        <div
            ...
            <div class="flex flex-row items-center">
                ...
                <input v-if="value1name"
                       v-model="value1"
                       :class="value2name == null ? 'rounded-md border' : 'md:rounded-l md:rounded-r-none md:border-r-0'"
                       :placeholder="value1name" class="flex w-full rounded  border-gray-300 p-2" name="value1"
                       type="text" />
                <input v-if="value2name" v-model="value2" :placeholder="value2name"
                       class="flex w-full rounded md:rounded-r md:rounded-l-none border border-gray-300 p-2"
                       name="value2"
                       type="text" />
                <!--Add Button-->
                <div class="flex items-center justify-center ml-1 h-10">
                    <t-button color="green" type="button" @click="addItem">
                        <iconify-icon icon="mingcute:add-line" class="w-6 h-6 md:w-5 md:h-5"></iconify-icon>
            ...
            <div v-for="(item,index) in modelValue" :key="index"
                 class="grid grid-cols-12 bg-gray-50 border rounded-md items-center space-x-2 pl-2 pr-5 py-1">
                <!--Counter-->
                ...
                <!--Delete Button-->
                <iconify-icon icon="tabler:trash" class="col-span-1 h-6 w-auto mr-2 text-red-500 cursor-pointer"
                              @click="deleteItem(index)"></iconify-icon>
            </div>
            <!--Close Button-->
