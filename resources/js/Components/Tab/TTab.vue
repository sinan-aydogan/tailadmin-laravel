  ...
  <div class="flex flex-col w-full">
    <div
      ...
      <div
          ...
          :key="index"
          :class="[
              'flex justify-start cursor-pointer font-semibold',
               tabStyle === 1 ?
...
export default {
  ...
  created() {
      for(let i = 0; i < getCurrentInstance().slots.default().length; i++){
          if(getCurrentInstance().slots.default()[i].children === Object){
              this.tabs = this.tabs + [getCurrentInstance().slots.default()[i].children]
          }
      }
