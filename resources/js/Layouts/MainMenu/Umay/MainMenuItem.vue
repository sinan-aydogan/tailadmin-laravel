        ...
        >
            ...
            <div>
                <iconify-icon
                    ...
                    class="h-6 w-6 mr-1 transition-size-medium"
                ...
                <template v-for="subItem in link.links" :key="subItem">
                    ...
                    >
                        <div class="flex space-x-2 items-center">
                            <iconify-icon v-if="subItem['icon']" :icon="subItem.icon" />
                        ...
                        >
                            <div class="flex flex-col space-y-4 w-full">
                                <template v-for="thirdItem in subItem.links" :key="thirdItem">
                                    <!--Third: Route-->
                                    <Link v-if="thirdItem.type === 'route' && thirdItem.visibleFor !== false"
                                          :class="[
                                    ...
                                    >
                                        <div class="flex justify-between space-x-2 py-2 items-center w-full">
                                            ...
                                            <iconify-icon v-if="thirdItem['icon']" :icon="thirdItem.icon" />
                                        </div>
                                    </Link>
