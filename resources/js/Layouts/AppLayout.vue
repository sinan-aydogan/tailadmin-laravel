  ...
  <div class="overflow-hidden">
    ...
    <div class="flex h-screen bg-gray-100">
      ...
      <div class="main-area">
        ...
        <div :class="[
            'top-menu',
            windowWidth < 640  ? 'w-screen' : 'w-full'
            ]">
          <!--Left Menu Trigger-->
              <transition-group name="trigger" tag="div"
                                :class="[
                                    'trigger',
                                    windowWidth >= 768 && 'trigger-bordered'
                                    ]"
              ...
              >
                <t-hamburger-menu-trigger-icon
                    :class="['absolute',windowWidth >= 768 ? 'w-6' : 'w-8']"
          ...
          <div class="user-menu">
            ...
            <t-dropdown
              ...
              <template #default>
                <div class="dropdown-list-container hidden md:block">
                  <!-- Account Management -->
                  <div class="dropdown-header">
                    Manage Account
                  </div>
        ...
        <div :class="[
            'content-container',
            windowWidth < 768  ? 'w-screen' : 'w-full'
            ]">
          <!--Content Header-->
