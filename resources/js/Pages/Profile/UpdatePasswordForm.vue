        ...
        <template #status>
            ...
            <t-form-section
                ...
                title="Update Password">
                    <!-- Current Password -->
                    <t-input-group class="col-span-12" :error="form.errors.current_password" label="Current Password" label-for="current_password" error="You can't change password at the demo">
                        <t-input-text
                            id="current_password"
