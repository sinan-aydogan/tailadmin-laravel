      ...
      <grid-section col="1" gap="4">
        ...
        <grid-section :col="3" :gap="4">
          ...
          <t-content-card :width="1">
            ...
            <template #content>
              <t-list :radius="3" class="w-full" color="white">
                <t-list-item>
                  <template #icon>
          ...
          <t-content-card :width="2">
            ...
            <template #content>
              <!--Table-->
              <t-table :content="tableContent" :header="tableHeader" :radius="0" :shadow="false" color="white">
        ...
        <grid-section :col="3" :gap="4">
          <!--Red-Deleted-->
          <t-alert :closeable="true" color="red">
