            ...
            <t-form-content @reset="reset" @submitted="save">
                <t-form-section
                    ...
                    <t-input-group class="col-span-12 md:col-span-6" label="Manager - Searchable" labelFor="user_id">
                        <t-input-select v-model="form.user_id" :clear-button="true" :search="true" place-holder="Select"
                    ...
                    <!-- Phone -->
                    <t-input-group class="col-span-12 md:col-span-6" label="Phone" labelFor="phone">
                        <t-input-text id="phone" v-model="form.phone" mask="+99(999) 999-9999" name="phone"/>
                    </t-input-group>
                    <!-- Email -->
                    <t-input-group class="col-span-12 md:col-span-6" label="Email" labelFor="email">
                        <t-input-text id="email" v-model="form.email"/>
                    </t-input-group>
                    <!-- Status -->
                    <t-input-group class="col-span-12 md:col-span-6" label="Status" labelFor="status">
                        <t-input-select :clear-button="true" place-holder="Select"
                                        search-place-holder="Search...">
                            <t-input-select-item value="1">
                                <font-awesome-icon class="text-green-500 mr-2" icon="check"/>
                                Active
                            </t-input-select-item>
                            <t-input-select-item value="2">
                                <font-awesome-icon class="text-red-500 mr-2" icon="minus-circle"/>
                                Passive
                            </t-input-select-item>
                        </t-input-select>
                    </t-input-group>
                    ...
                    <t-input-group class="col-span-12" label="Address" labelFor="address">
                        <t-input-text-area id="address" v-model="form.address" :clear-button="true" :counter="true"
        ...
        return {
            ...
            sampleCode: {
                html: '<t-form-content @submitted="save" @reset="reset">\n' +
                    ...
                    '            <t-input-text id="name"  v-model="form.name" placeholder="Business mail address"/>\n' +
                    '        </t-input-group>\n' +
                    '        <!-- Manager - Searchable Select Input -->\n' +
                    '        <t-input-group label="Manager - Searchable" labelFor="user_id" class="col-span-12 md:col-span-6">\n' +
                    '            <t-input-dropdown v-model="form.user_id" :clear-button="true" place-holder="Select" search-place-holder="Search...">\n' +
                    '                <t-input-dropdown-item v-for="(item,index) in users" :value="item.id" :key="index"><span :class="item.class">{{ item.name }}</span></t-input-dropdown-item>\n' +
                    '            </t-input-dropdown>\n' +
                    '        </t-input-group>\n' +
                    '        <!-- Tax ID -->\n' +
