            ...
            <grid-section :col="1" :gap="4">
                <template v-for="content in demoContents" :key="content.id">
                    ...
                    >
                        ...
                        >
                            <template v-if="content.icon || content.media" #icon>
                                <iconify-icon v-if="content.icon" :icon="content.icon" class="w-7 h-7" />
                        ...
                        >
                            <iconify-icon icon="info" size="lg" />
                        ...
                        <template #label="slotProps">
                            <iconify-icon v-if="slotProps.tab.id === 'timer'" icon="play" size="sm" />
        ...
        const { t, tm } = useI18n({
            ...
            messages: {
                en: {
                    ...
                    docMessageDesc: "If you would like to display a message using the alert component, pass/set any value through this prop.",
                    docIconDesc: "If you would like to display an icon using the alert component, pass/set any value through this prop.",
                ...
                tr: {
                    ...
                    docMessageDesc: "Uyarı kutusu içinde istediğiniz mesajı gösterebilmenizi sağlar.",
                    docIconDesc: "Uyarı kutusu içinde istediğiniz ikonu gösterebilmenizi sağlar.",
        ...
        const docProps = {
            ...
            content: [
                ...
                },
                {
                    ...
                    prop: "message",
                    type: "String",
                    description: tm("docMessageDesc")
                },
                {
                    id: "icon",
                    prop: "icon",
                    type: "String",
                    description: tm("docIconDesc")
                },
                {
                    id: "closeable",
                    prop: "closeable",
        ...
        const docSamples = {
            filled: {
                ...
                template: "<t-alert\n" +
                    ...
                    "    title=\"Success\"\n" +
                    "    icon=\"tabler:circle-check\"\n" +
                    "    message=\"The post added successfully (filled)\"\n" +
                    "    :radius=1\n" +
                    "    :closeable=\"true\"\n" +
                    "/>"
            },
            light: {
                ...
                template: "<t-alert\n" +
                    ...
                    "    title=\"Danger\"\n" +
                    "    icon=\"tabler:trash\"\n" +
                    "    message=\"The user deleted successfully (light)\"\n" +
                    "    :closeable=\"true\"\n" +
                    "/>"
            },
            inline: {
            ...
            outline: {
                ...
                template: "<t-alert\n" +
                    ...
                    "    color=\"info\"\n" +
                    "    icon=\"tabler:repeat\"\n" +
                    "    message=\"You entered a new configuration, the settings will refresh 24hr after (outline)\"\n" +
                    "    :closeable=\"false\"\n" +
                    "/>"
            },
            gradient: {
            ...
            block: {
                ...
                template: "<t-alert\n" +
                    ...
                    "    color=\"info\"\n" +
                    "    icon=\"tabler:info-circle\"\n" +
                    "    message=\"Please, check your task list (block)\"\n" +
                    "    :closeable=\"true\"\n" +
                    "/>"
            }
        };
