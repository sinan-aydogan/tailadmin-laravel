    ...
    <template #default>
      <grid-section col="3" gap="4">
        ...
        <t-content-card width="3">
          ...
          <template #content>
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
              <t-alert v-for="(i,index) in colors" :radius="3" :color="i" :key="index">
        ...
        <t-content-card width="3">
          ...
          <template #content>
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
              ...
              <t-alert v-for="(i,index) in 8" :radius="i" :color="colors[i]" :key="index">
                <font-awesome-icon slot="icon" icon="info-circle" size="lg"/>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              </t-alert>
            </div>
        ...
        <t-content-card width="3">
          ...
          <template #content>
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
              <t-alert :closeable="true" :border="true" v-for="(i,index) in 3" :radius="3" :color="colors[i]" :key="index">
                <font-awesome-icon slot="icon" icon="check" size="lg"/>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              </t-alert>
            </div>
        ...
        <t-content-card width="3">
          ...
          <template #content>
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
              ...
              <t-button :radius="5" color="green" @click.native="addAlertBox" size="full">
