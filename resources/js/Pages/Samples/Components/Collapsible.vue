...
export default defineComponent({
    ...
    components: {
        ...
        GridSection, AppLayout, TContentCard, TCollapsible, TCollapsibleItem, SshPre, TTable},
    setup() {
        ...
        return {collapsibleActive, collapsibleActive2, collapsibleActive3,sampleCode, test}
    }
})
</script>
