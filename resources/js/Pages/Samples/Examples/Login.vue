          ...
          content: [
            {
              variable: 'color',
              type: 'String',
              details: "Your login form continer\'s color theme.<br><b>Options Solid:</b> solid-red, solid-blue, solid-green, solid-yellow, solid-indigo, solid-pink, solid-purple, solid-gray, solid-black, solid-white,<br>" +
