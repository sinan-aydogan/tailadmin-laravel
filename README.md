TailAdmin™ Laravel with Inertia
======
...
<p align="center">
  It's a dashboard theme/UI-Starter Kit with Laravel10, TailwindCSS3, Inertia, Vitejs and Vue3 (JetStream).
</p>

<p align="center">
  :wave: If you looking for Vue2 version, You can use download <a href="https://github.com/sinan-aydogan/tailadmin-laravel/releases/tag/v.1.0.0"> TailAdmin™ v1</a> :wave:
</p>
...
- TailwindCSS
- Vitejs
- Vue.js 3 Laravel 10 - JetStream Inertia
...
License
------
TailAdmin™ is a trademark.

TailAdmin™ Laravel is open-sourced software licensed under the [MIT license](https://opensource.org/licenses/MIT).
